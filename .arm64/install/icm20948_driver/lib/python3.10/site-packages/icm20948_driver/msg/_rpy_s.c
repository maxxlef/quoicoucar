...
bool icm20948_driver__msg__rpy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("icm20948_driver.msg._rpy.RPY", full_classname_dest, 28) == 0);
  }
  icm20948_driver__msg__RPY * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RPY */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("icm20948_driver.msg._rpy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RPY");
