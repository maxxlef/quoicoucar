...
#include "icm20948_driver/msg/detail/raw_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = icm20948_driver::msg::RawData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const icm20948_driver::msg::RawData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<icm20948_driver::msg::RawData *>(
    untyped_ros_message);
...
static size_t _RawData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RawData(full_bounded, is_plain, 0);
...
{
  return &icm20948_driver::msg::typesupport_fastrtps_cpp::_RawData__handle;
}
