...
#include "icm20948_driver/msg/detail/raw_data__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // accel, gyro, mag
...
using _RawData__ros_msg_type = icm20948_driver__msg__RawData;
...
size_t get_serialized_size_icm20948_driver__msg__RawData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RawData__ros_msg_type * ros_message = static_cast<const _RawData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RawData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_icm20948_driver__msg__RawData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_icm20948_driver
size_t max_serialized_size_icm20948_driver__msg__RawData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = icm20948_driver__msg__RawData;
    is_plain =
      (
...
static size_t _RawData__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_icm20948_driver__msg__RawData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, icm20948_driver, msg, RawData)() {
