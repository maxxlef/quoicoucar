...
#include "icm20948_driver/msg/detail/rpy__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration
...
using _RPY__ros_msg_type = icm20948_driver__msg__RPY;
...
size_t get_serialized_size_icm20948_driver__msg__RPY(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RPY__ros_msg_type * ros_message = static_cast<const _RPY__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RPY__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_icm20948_driver__msg__RPY(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_icm20948_driver
size_t max_serialized_size_icm20948_driver__msg__RPY(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = icm20948_driver__msg__RPY;
    is_plain =
      (
...
static size_t _RPY__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_icm20948_driver__msg__RPY(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, icm20948_driver, msg, RPY)() {
