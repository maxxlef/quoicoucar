...
static const _GpsFix_type_support_symbol_names_t _GpsFix_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpsd_client, msg, GpsFix)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpsd_client, msg, GpsFix)),
  }
};
...
{
  return &::gpsd_client::msg::rosidl_typesupport_cpp::GpsFix_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpsd_client, msg, GpsFix)() {
  return get_message_type_support_handle<gpsd_client::msg::GpsFix>();
}
