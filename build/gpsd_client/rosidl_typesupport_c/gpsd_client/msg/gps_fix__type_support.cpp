...
static const _GpsFix_type_support_symbol_names_t _GpsFix_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gpsd_client, msg, GpsFix)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gpsd_client, msg, GpsFix)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gpsd_client, msg, GpsFix)() {
  return &::gpsd_client::msg::rosidl_typesupport_c::GpsFix_message_type_support_handle;
}
