...
#include "voiture2a_motors_driver/msg/detail/motors_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 2;
    size_t item_size = sizeof(ros_message.pwm_value[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = voiture2a_motors_driver::msg::MotorsState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const voiture2a_motors_driver::msg::MotorsState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<voiture2a_motors_driver::msg::MotorsState *>(
    untyped_ros_message);
...
{
  return &voiture2a_motors_driver::msg::typesupport_fastrtps_cpp::_MotorsState__handle;
}
