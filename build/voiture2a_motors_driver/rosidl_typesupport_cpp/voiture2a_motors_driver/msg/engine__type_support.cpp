...
static const _Engine_type_support_symbol_names_t _Engine_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, voiture2a_motors_driver, msg, Engine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, voiture2a_motors_driver, msg, Engine)),
  }
};
...
{
  return &::voiture2a_motors_driver::msg::rosidl_typesupport_cpp::Engine_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, voiture2a_motors_driver, msg, Engine)() {
  return get_message_type_support_handle<voiture2a_motors_driver::msg::Engine>();
}
